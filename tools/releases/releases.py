...
GH_OWNER = "dic1911"  # Github profile name
...
📔 [Device Changelog](https://raw.githubusercontent.com/dic1911/{GH_REPO}/main/lineage-{GH_LINEAGE[:-2]}/changelog_{GH_TAG.replace('-', '')}.txt)
